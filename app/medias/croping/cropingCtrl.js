...
angular.module('app')
  .controller('cropingCtrl', function ($scope) {
      $scope.$on('$viewContentLoaded', function () {
          ...
          (function () {
              ...
              $("#set-img-1").click(function () {
                  ...
                  $image.cropper("setImgSrc", "../images/gallery/picture-1.jpg");
              });
              ...
              $("#set-img-2").click(function () {
                  ...
                  $image.cropper("setImgSrc", "../images/gallery/picture-2.jpg");
              });
              ...
              $("#set-img-3").click(function () {
                  ...
                  $image.cropper("setImgSrc", "../images/gallery/picture-3.jpg");
              });
